    ...
    <section className="mt-8">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="p-5 bg-white rounded-lg dark:bg-gray-800/70">
              ...
              {latestpost?.map(item => (
                ...
                >
                  <Link to="/single-post">
                    <img
                      className="w-full sm:w-64 h-auto rounded-2xl object-cover"
                      src={item.pic}
                      alt="post"
                    />
                  </Link>
                  <div className="flex-1">
                    ...
                    <Link to="/single-post">
                      <h5 className="mb-1 text-xl leading-snug font-medium text-gray-900 dark:text-white hover:text-[#062db9] dark:hover:text-[#478cff]">
                        {item.desc}
                      </h5>
                    </Link>
                    ...
                    <div className="text-[12px] text-gray-500 dark:text-gray-400 uppercase">
          ...
          {/* Sidebar Section */}
          <div className="lg:col-span-1 lg:h-full space-y-8" data-aos="flip-right">
            {/* Join With Us */}
            ...
            <div className="p-6 bg-white dark:bg-gray-800/70 rounded-xl shadow">
              ...
              <div className="mt-4 space-y-4">
                <input
                  type="email"
                  className="form-input px-4 py-3 rounded-md w-full border text-base dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                  placeholder="Enter your email"
                />
                <button className="uppercase tracking-wide rounded-md px-6 py-3 bg-[#ff3750] hover:bg-gray-700 w-full text-sm text-white transition-all duration-200">
                  Subscribe
                </button>
              </div>
            </div>
